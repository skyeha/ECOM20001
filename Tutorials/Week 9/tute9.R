...
# a. age changes from 25 (newdata1) to 28 (newdata2)  (how tute9.R is originally set-up)
...
## (in original tute9.R set-up, change to 28 and 31 for question 6 parts b. and c.)
...
## (in original tute9.R set-up, change to 31 and 35 for question 6 parts b. and c.)
