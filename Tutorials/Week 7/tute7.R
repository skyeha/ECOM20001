...
# Reminder: if you have not already done so (say in Tutorial 6), you must 
...
# See Tutorials 1 or 6, and specifically the tute6.pdf or tute6.R files for details on 
# installing and loading packages. 

# If you previously installed these packages in Tutorial 6, then you do not have to 
...
# NOTE: 'stargazer' reports regression F-statistics that assume homoskedasticity. Unfortunately, it
# is not straightforward to fix this so stargazer() reports F-statistics that instead assume 
# homoskedasticity

## Fixing this using the linearHypothesis() command
