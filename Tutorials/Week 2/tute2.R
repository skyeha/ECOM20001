...
setwd("D:/Semester 2 2022/ECOM20001/Tutorials/Week 2")
...
#**********************************************************************************************
# 4. DESCRIPTIVE STATISTICS: stargazer(), quantile(), IQR()
...
## Returns Number of Observations, Mean, Standard Deviation, Median, Min, Max
## Outputs the table to a file "sumstats.txt" and saves to your working directory
stargazer(data, 
          summary.stat = c("n", "mean", "sd", "median", "min", "max"),  
          type="text", title="Descriptive Statistics",
          out="sumstats.txt")
# You can also report other statistics if needed by changing other
# options in the line: summary.stat = c("n", "mean", "sd", "median", "min", "max"),  
