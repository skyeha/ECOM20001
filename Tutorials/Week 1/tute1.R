...
#**********************************************************************************************
# 5. LOADING AND INSTALLING PACKAGES
...
# We can install packages through "point and click" using the bottom right hand window
# of the standard R-Studio setup where you have "Files" "Plots" "Packages" "Help" and "Viewer" tabs
# To install a package you click on the "Package" tab, then click on of the boxes on the far
# left of the window under "System Library" where you will see a list of packages you can also 
# install. After clicking a box, click the "Install" button just under the "Files" tab and the 
# package will be installed

# A more direct way to install a package, however, is to just run a line of code
# Here, we will install the "stargazer" and "AER" packages as examples as these are packages
# that we will use often throughout the subject
