...
# In this tutorial, we will use 2 new commands: coeftest() and vcovHC()
  # coeftest() and vcovHC() compute and display heteroskedasticity-robust (or "White")  standard errors

# We will also introduce a new function of stargazer(): multiple linear regression
...
# INSTALLATION (reminder from Tutorial 1) of AER AND STARGAZER packages
