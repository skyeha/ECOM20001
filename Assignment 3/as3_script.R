...
# null hypothesis: pinoitnoir, carbernet, merlot, and syrah has the same effect on wine price
...
Model1CI95H = model1Effect + seModel1
Model1CI95L = model1Effect - seModel1
...
FtestModel2 = linearHypothesis(reg2, c("5*score + 825*score2"), vcov = cov2)
FtestModel2
...
FtestModel3 = linearHypothesis(reg3, c("5*score + 825*score2"), vcov = cov3)
FstatModel3 = FtestModel2[2,3]

seModel3 = abs(model3Effect)/sqrt(FstatModel3)
Model2CI95H = model3Effect + seModel3
Model2CI95L = model3Effect - seModel3
...
# A 1% increase score will yield a %5.709 increase in price. That is, the elasticity of score with respect to age 
# is 5.709.
...
t.test(wineData$log_score, mu = 1)
